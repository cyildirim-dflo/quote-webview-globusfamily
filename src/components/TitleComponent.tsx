    ...
    return (
        <div className="w-full flex justify-center">
            <div className="flex flex-col px-2 pb-[40px] w-auto">
                <h3 className="text-sm md:text-lg font-serif text-secondary inline-block uppercase text-left ">
                    {preTitle}
                </h3>
                <h3 className="text-4xl md:text-5xl font-serif text-primary relative border-b border-secondary inline-block w-max pb-4">
                    {title}
