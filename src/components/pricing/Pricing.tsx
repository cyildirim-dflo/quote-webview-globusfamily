    ...
    return (
        <div className='w-full bg-white'>
            <div className='flex flex-col max-md:px-2 pt-[80px] max-w-screen-2xl mx-auto'>
                <h2 className="font-serif font-bold text-4xl md:text-5xl text-center text-brownish mb-[40px]">
                    {section.title}
                </h2>
            ...
            <div className='mx-auto w-full max-w-screen-xl flex flex-col py-[10px] mt-[10px] gap-6 text-center' >
                    <div>
                        ...
                        <p className='text-xl'>
                            Please ensure you read our Booking Conditions, which can be found in full on our website. Payment of a deposit confirms you have read and accept our   <a href="https://www.alexanderroberts.com/terms-and-conditions.aspx" className="font-semibold">Terms and Conditions</a> .
                            <br />
                        </p>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <p className='text-xl'>
                            To pay a deposit or the full amount for your holiday, please click the 'Book Trip' button below or call your Travel Consultant. Alexander+Roberts accepts payments by direct debit, credit card or bank transfer.
                        </p>
                    </div>
                </div>
            </div>
